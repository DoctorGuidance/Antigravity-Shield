# 📜 Legacy Upstream Changelog (v4.6.7 and Earlier)

> This document contains historical release notes for ancestral and upstream releases (v4.6.7 and earlier) prior to the formal rebranding, security hardening, and architectural overhaul of **Antigravity Shield (v5.0.0+)**.
> For active Antigravity Shield releases, please refer to the primary [CHANGELOG.md](CHANGELOG.md).
