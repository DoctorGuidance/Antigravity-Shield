...
function CurrentAccount({ account, onSwitch }: CurrentAccountProps) {
    ...
    if (!account) {
        return (
            <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl p-5 shadow-sm border border-slate-200/80 dark:border-slate-800/80 hover:border-cyan-500/30 transition-all duration-200 cyber-card">
    ...
    return (
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl p-5 shadow-sm border border-slate-200/80 dark:border-slate-800/80 hover:border-cyan-500/30 transition-all duration-200 cyber-card h-full flex flex-col">
