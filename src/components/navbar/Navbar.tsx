...
function Navbar() {
    ...
    return (
        <nav
            ...
            className="pt-9 transition-all duration-200 bg-white/80 dark:bg-[#090d16]/85 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 shadow-sm"
        >
            {/* 窗口拖拽区域 - Tauri 专用 */}
            {isTauri() && (
                <div
