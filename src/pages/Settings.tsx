...
import { Save, Github, User, ExternalLink, RefreshCw, Heart, Coffee, LayoutDashboard, Users, Network, Activity, BarChart3, Settings as SettingsIcon, Lock, CheckCircle2, Globe, Sparkles, Loader2, RotateCcw } from 'lucide-react';
                        ...
                        <div className="flex flex-col h-full animate-in fade-in duration-500">
                            <div className="flex-1 flex flex-col justify-center items-center space-y-8">
                                ...
                                <div className="text-center space-y-4">
                                    ...
                                    <div>
                                        <h3 className="text-3xl font-black text-gray-900 dark:text-base-content tracking-tight mb-2">{t('common.app_name', 'Antigravity Shield')}</h3>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full max-w-4xl px-4">
                                    ...
                                    <div className="bg-white dark:bg-base-100 p-4 rounded-2xl border border-gray-100 dark:border-base-300 shadow-sm hover:shadow-md hover:border-blue-200 dark:hover:border-blue-800 transition-all group flex flex-col items-center text-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="font-bold text-gray-900 dark:text-base-content">DoctorGuidance</div>
                                        </div>
                                    </div>

                                    {/* GitHub Card */}
                                    <a
                                        href="https://github.com/DoctorGuidance/Antigravity-Shield"
                                        target="_blank"
                                        rel="noreferrer"
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-gray-50 dark:bg-base-200 rounded-lg p-3">
                            <div className="flex items-center justify-between gap-2">
                                <code className="text-xs text-gray-700 dark:text-gray-300 break-all">brew upgrade --cask antigravity-shield</code>
                                <button
                        ...
                        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/30 rounded-lg p-3">
                            ...
                            <div className="flex items-center justify-between gap-2">
                                <code className="text-xs text-amber-800 dark:text-amber-300 break-all">sudo xattr -rd com.apple.quarantine "/Applications/Antigravity Shield.app"</code>
                                <button
